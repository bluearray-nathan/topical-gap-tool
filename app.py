...
st.sidebar.header("About AI Overview/AI Mode query fan-out gap analysis tool")
st.sidebar.write(
    """This tool helps identify where gaps exist in your content in relation to AI Overview/AI Mode query fan-outs:
